...
const Navbar = ({ handleOrderPopup }) => {
  return (
    <div className="shadow-md bg-white dark:bg-text-white duration-200 relative z-40">
      ...
      <div data-aos="zoom-in" className="flex justify-center dark:bg-black">
        <ul className="sm:flex hidden items-center gap-4">
          ...
          <li className="group relative cursor-pointer">
            ...
            <div className="absolute z-[9999] hidden group-hover:block w-[200px] rounded-md bg-white p-2 text-black shadow-md dark:bg-black dark:text-white">
              <ul className="">
